...
Blockly.Blocks['curry'] = {
  init: function () {
    this.appendDummyInput().appendField('カレー');
...
Blockly.Blocks['park'] = {
  init: function () {
    this.appendDummyInput().appendField('公園');
    this.setNextStatement(true, null);
    this.setColour(0);
...
Blockly.Blocks['baseball'] = {
  init: function () {
    this.appendDummyInput().appendField('野球');
    this.setNextStatement(true, null);
    this.setColour(0);
...
Blockly.Blocks['game'] = {
  init: function () {
    this.appendDummyInput().appendField('ゲーム');
    this.setNextStatement(true, null);
    this.setColour(0);
    this.setTooltip('げーむ');
    this.setHelpUrl('');
...
Blockly.Blocks['bicycle'] = {
  init: function () {
    this.appendDummyInput().appendField('自転車');
    this.setNextStatement(true, null);
    this.setColour(0);
...
Blockly.Blocks['car'] = {
  init: function () {
    this.appendDummyInput().appendField('車');
    this.setNextStatement(true, null);
    this.setColour(0);
    this.setTooltip('くるま');
    this.setHelpUrl('');
...
Blockly.Blocks['train'] = {
  init: function () {
    this.appendDummyInput().appendField('電車');
    this.setNextStatement(true, null);
    this.setColour(0);
